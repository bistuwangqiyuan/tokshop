...
export const dict = {
  en: {
    ...
    contactPage: {
      ...
      topics: [
        "Refunds and billing questions - include the order id and the email you used at checkout.",
        "A payment that succeeded at your bank but did not appear as balance or as a download.",
        "Getting a copy of your data, correcting it, or having your account and its data deleted.",
        "Reporting abuse of the API under our acceptable use policy.",
        "Anything about the service you cannot work out from the docs.",
      ],
      policiesTitle: "Before you write",
      policiesBody:
        "Most billing questions are already answered in writing, with worked examples:",
    },
    legal: {
      updated: "Last updated",
      sellerTitle: "Who you are buying from",
      operator: "Operator",
    ...
    pricing: {
      ...
      buy: "Top up",
      guestHint: "Topping up needs an account. Want to try checkout first?",
      guestLink: "Buy the $1 handbook with just an email",
    },
    blog: {
      title: "Blog",
  ...
  zh: {
    ...
    contactPage: {
      ...
      topics: [
        "退款与计费问题 —— 请附上订单号和结账时使用的邮箱。",
        "银行侧已扣款成功，但余额未到账或下载未开通。",
        "获取你的数据副本、更正数据，或删除账号及其全部数据。",
        "依据可接受使用政策举报接口滥用行为。",
        "任何在文档里找不到答案的问题。",
      ],
      policiesTitle: "写信之前",
      policiesBody: "大多数计费相关的问题都已白纸黑字写清楚，并附了算例：",
    },
    legal: {
      updated: "最近更新",
      sellerTitle: "你在向谁购买",
    ...
    pricing: {
      ...
      starterBadge: "每账号限一次",
      buy: "充值",
      guestHint: "充值需要账号。想先体验一次结账？",
      guestLink: "只填邮箱即可购买 1 美元手册",
    },
    blog: {
      title: "博客",
